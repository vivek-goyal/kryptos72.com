<?php exit; ?>{
    ...
    "minify.css.groups": {
        "19024": {
            "default": {
                "include": {
                    "files": [
                        "\/\/fonts.googleapis.com\/css?family=Playfair+Display%3Aregular%2Citalic%2C700%2C700italic%2C900%2C900italic&#038;ver=5.0.3"
                    ]
                }
            }
        }
    ...
    "minify.csstidy.options.lowercase_s": "1",
    "minify.csstidy.options.optimise_shorthands": "1",
    "minify.csstidy.options.remove_last_;": "1",
    "minify.csstidy.options.remove_space_before_important": "1",
    "minify.csstidy.options.case_properties": "1",
    "minify.csstidy.options.sort_properties": "1",
    "minify.csstidy.options.sort_selectors": "1",
    "minify.csstidy.options.merge_selectors": "2",
    "minify.csstidy.options.discard_invalid_selectors": "1",
    "minify.csstidy.options.discard_invalid_properties": "1",
    "minify.csstidy.options.css_level": "CSS2.1",
    "minify.csstidy.options.preserve_css": "1",
    "minify.csstidy.options.timestamp": "1",
