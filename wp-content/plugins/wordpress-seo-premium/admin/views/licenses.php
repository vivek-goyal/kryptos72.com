	...
	<div id="extensions">
		<section class="yoast-seo-premium-extension">
			...
			<?php if ( $extension_list->is_installed( $extension->get_title() ) ) : ?>
				...
				<?php else : ?>
					<div class="yoast-button yoast-button--noarrow yoast-button--extension yoast-button--extension-not-activated"><?php esc_html_e( 'Activated By GPLPlus', 'wordpress-seo' ); ?></div>
