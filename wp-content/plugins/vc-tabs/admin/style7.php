                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#content-border-color").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ultimate-wrapper-<?php echo $styleid; ?>{ border-color:" + jQuery('#content-border-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                jQuery("#content-border-radius").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ultimate-wrapper-<?php echo $styleid; ?>{ border-radius:" + jQuery('#content-border-radius').val() + "px " + jQuery('#content-border-radius').val() + "px 0 0 ;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
