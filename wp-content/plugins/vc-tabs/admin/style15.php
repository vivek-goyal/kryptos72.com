                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                if (empty($styledata[63])) {
                                                    ...
                                                    echo VcTabsAdminTabsInitialOpen($styledata[63]);
                                                }
                                                ?>
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-margin-bottom").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li{ margin-bottom: " + jQuery('#heading-margin-bottom').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                ...
                                jQuery("#content-box-shadow-Blur").on("change", function () {
                                    ...
                                    jQuery("<style type='text/css'>  @media only screen and (max-width: 900px) {.ctu-ultimate-style-heading-<?php echo $styleid; ?> {box-shadow :" + idvalue + ";}} </style>").appendTo(" .ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text "class="form-control" id="ctu-icon" name="ctu-icon" value="<?php echo ctu_admin_special_charecter($icon); ?>">
