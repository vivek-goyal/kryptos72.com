	...
	<?php foreach ( $get_addresses as $name => $title ) { ?>
		...
		<div class="col-sm-6">
			<div class="wc-account-address">
				<header class="title">
					<h3 class="wc-account-address_h"><?php echo wp_kses($title, 'post'); ?></h3>
					<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>" class="wc-account-address_edit"><?php esc_html_e( 'Edit', 'woocommerce' ); ?></a>
				</header>
				<address>
					<?php
						...
						if ( ! $formatted_address )
							...
							echo wp_kses($formatted_address, 'post');
					?>
				</address>
			</div>
		</div>
