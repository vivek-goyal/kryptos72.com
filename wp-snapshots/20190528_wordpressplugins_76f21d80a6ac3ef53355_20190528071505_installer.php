...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20190528_wordpressplugins_76f21d80a6ac3ef53355_20190528071505_archive.zip';
	const ARCHIVE_SIZE		 = '333264881';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '76f21d8-28071505';
	const VERSION			 = '1.3.2';
